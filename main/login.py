...
def forget_pass():
    def change_password():
        if user_entry.get() == '' or newpass_entry.get() == '' or confirmpass_entry.get() == '':
            ...
            con = pymysql.connect(host='localhost', user='root', password='Abhivesh@2003', database='userdata')
            mycursor = con.cursor()
    ...
    submitButton = Button(window, text='Submit', font=('Open Sans', 15, 'bold'), fg='magenta2', bg='white',
                          activeforeground='magenta2', activebackground='white', cursor='hand2', bd=0, width=19,
...
def login_user():
    if usernameEntry.get() == '' or passwordEntry.get() == '':
        ...
        try:
            con = pymysql.connect(host='localhost', user='root', password='Abhivesh@2003')
            mycursor = con.cursor()
        except:
...
heading = Label(login_window, text='Traffic Simulator', font=('MV Boli', 23, 'bold'), bg='white')
...
loginButton = Button(login_window, text='Login', font=('Open Sans', 15, 'bold'), fg='VioletRed4', bg='white',
                     activeforeground='VioletRed4', activebackground='white', cursor='hand2', bd=0, width=19,
                     command=login_user)
loginButton.place(x=578, y=350)

orLabel = Label(login_window, text='---------- OR ----------', font=('Open Sans', 15), bg='pink', fg='VioletRed4')
orLabel.place(x=620, y=430)

red_logo = PhotoImage(file='/Users/abhivesh/Downloads/Python Project/red_logo.png')
redLabel = Label(login_window, image=red_logo, bg='white').place(x=620, y=130)

yellow_logo = PhotoImage(file='/Users/abhivesh/Downloads/Python Project/yellow_logo.png')
yellowLabel = Label(login_window, image=yellow_logo, bg='white').place(x=670, y=130)

green_logo = PhotoImage(file='/Users/abhivesh/Downloads/Python Project/green_logo.png')
greenLabel = Label(login_window, image=green_logo, bg='white').place(x=720, y=130)

signupLabel = Label(login_window, text='Dont have an account? ', font=('Open Sans', 12, 'bold'), fg='white',
                    bg='VioletRed4', activeforeground='white', activebackground='white', cursor='hand2', bd=0, )

signupLabel.place(x=560, y=500)

newaccountButton = Button(login_window, text='Create New Account', font=('Open Sans', 10, 'bold underline'), fg='blue',
                          activeforeground='white', activebackground='white', cursor='hand2', bd=0, command=signup_page)

newaccountButton.place(x=705, y=498)
